...
module l2_reg (
  ...
  logic csr_en_1, csr_en_2, reg_file_read_en_1, reg_file_read_en_2, reg_file_write_en_1, reg_file_write_en_2;
  logic alu_en_1, alu_en_2, branch_logic_en_1, branch_logic_en_2, data_mem_en_1, data_mem_en_2, reg_file_pass_through;
  logic [31:0] pc_1, imm_offset_1, lui_1, csr_data_from_ctrl_1, csr_data_from_ctrl_2, pc_2, imm_offset_2, lui_2, pc_3;
  logic [31:0] pc_4, rs1_data_1, rs2_data_1;
  logic [4:0] rs1_1, rs2_1, rd_1, rs1_2, rs2_2, rd_2;
  csr_addr_t csr_addr_1, csr_addr_from_ctrl_1, csr_addr_from_ctrl_2, csr_addr_2;
  sel_csr_addr_t csr_addr_mux_sel_1, csr_addr_mux_sel_2;
  sel_csr_data_t csr_data_mux_sel_1, csr_data_mux_sel_2;
  write_t csr_write_type_1, csr_write_type_2;
  rw_t csr_rw_1, csr_rw_2, data_mem_rw_1, data_mem_rw_2;
  sel_reg_file_data_t reg_file_data_mux_sel_1, reg_file_data_mux_sel_2;
  alu_opr_t alu_opr_1, alu_opr_2, bl_opr_1, bl_opr_2;
  sel_alu_a_t alu_a_mux_sel_1, alu_a_mux_sel_2;
  sel_alu_b_t alu_b_mux_sel_1, alu_b_mux_sel_2;
  transfer_t data_mem_transfer_type_1, data_mem_transfer_type_2;
  load_t data_mem_load_type_1, data_mem_load_type_2;
  ...
  always_ff @(posedge clk_i) begin
    if (!rst_i) begin
      ...
      csr_addr_from_ctrl_2     <= csr_addr_from_ctrl_1;
      csr_addr_mux_sel_2       <= csr_addr_mux_sel_1;
      csr_data_mux_sel_2       <= csr_data_mux_sel_1;
      csr_write_type_2         <= csr_write_type_1;
      csr_rw_2                 <= csr_rw_1;
      csr_en_2                 <= csr_en_1;
      csr_data_from_ctrl_2     <= csr_data_from_ctrl_1;
      reg_file_data_mux_sel_2  <= reg_file_data_mux_sel_1;
      reg_file_read_en_2       <= reg_file_read_en_1;
      reg_file_write_en_2      <= reg_file_write_en_1;
      alu_opr_2                <= alu_opr_1;
      alu_a_mux_sel_2          <= alu_a_mux_sel_1;
      alu_b_mux_sel_2          <= alu_b_mux_sel_1;
      alu_en_2                 <= alu_en_1;
      bl_opr_2                 <= bl_opr_1;
      branch_logic_en_2        <= branch_logic_en_1;
      data_mem_transfer_type_2 <= data_mem_transfer_type_1;
      data_mem_rw_2            <= data_mem_rw_1;
      data_mem_load_type_2     <= data_mem_load_type_1;
      ...
      if (clear_l2_i == 1'b1) begin
        ...
        // CU
        l2_csr_addr_from_ctrl_o     <= (stall_l2_i == 1'b1) ? l2_csr_addr_from_ctrl_o : csr_addr_from_ctrl_2;
        l2_csr_addr_mux_sel_o       <= (stall_l2_i == 1'b1) ? l2_csr_addr_mux_sel_o : csr_addr_mux_sel_2;
        l2_csr_data_mux_sel_o       <= (stall_l2_i == 1'b1) ? l2_csr_data_mux_sel_o : csr_data_mux_sel_2;
        l2_csr_write_type_o         <= (stall_l2_i == 1'b1) ? l2_csr_write_type_o : csr_write_type_2;
        l2_csr_rw_o                 <= (stall_l2_i == 1'b1) ? l2_csr_rw_o : csr_rw_2;
        l2_csr_en_o                 <= (stall_l2_i == 1'b1) ? l2_csr_en_o : csr_en_2;
        l2_csr_data_from_ctrl_o     <= (stall_l2_i == 1'b1) ? l2_csr_data_from_ctrl_o : csr_data_from_ctrl_2;
        l2_reg_file_data_mux_sel_o  <= (stall_l2_i == 1'b1) ? l2_reg_file_data_mux_sel_o : reg_file_data_mux_sel_2;
        l2_reg_file_write_en_o      <= (stall_l2_i == 1'b1) ? l2_reg_file_write_en_o : reg_file_write_en_2;
        l2_alu_opr_o                <= (stall_l2_i == 1'b1) ? l2_alu_opr_o : alu_opr_2;
        l2_alu_a_mux_sel_o          <= (stall_l2_i == 1'b1) ? l2_alu_a_mux_sel_o : alu_a_mux_sel_2;
        l2_alu_b_mux_sel_o          <= (stall_l2_i == 1'b1) ? l2_alu_b_mux_sel_o : alu_b_mux_sel_2;
        l2_alu_en_o                 <= (stall_l2_i == 1'b1) ? l2_alu_en_o : alu_en_2;
        l2_bl_opr_o                 <= (stall_l2_i == 1'b1) ? l2_bl_opr_o : bl_opr_2;
        l2_branch_logic_en_o        <= (stall_l2_i == 1'b1) ? l2_branch_logic_en_o : branch_logic_en_2;
        l2_data_mem_transfer_type_o <= (stall_l2_i == 1'b1) ? l2_data_mem_transfer_type_o : data_mem_transfer_type_2;
        l2_data_mem_rw_o            <= (stall_l2_i == 1'b1) ? l2_data_mem_rw_o : data_mem_rw_2;
        l2_data_mem_load_type_o     <= (stall_l2_i == 1'b1) ? l2_data_mem_load_type_o : data_mem_load_type_2;
        l2_data_mem_en_o            <= (stall_l2_i == 1'b1) ? l2_data_mem_en_o : data_mem_en_2;
        // Reg file
        l2_rs1_data_o               <= (reg_file_pass_through == 1'b1) ? rs1_data_i : rs1_data_1;
        l2_rs2_data_o               <= (reg_file_pass_through == 1'b1) ? rs2_data_i : rs2_data_1;
      end
    end
  end

  always_ff @(posedge clk_i) begin
    if (!rst_i) reg_file_pass_through <= 1'b0;
    else begin
      if (stall_l2_i == 1'b1) reg_file_pass_through <= 1'b1;
      else reg_file_pass_through <= 1'b0;
    end
  end
endmodule
