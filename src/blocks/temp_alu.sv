...
module temp_alu (
  ...
  function logic [31:0] func_div(logic [31:0] a, b);
    if (b == 32'h80000000 && a == 32'hFFFFFFFF) return b;
    else if (a == 32'd0) return 32'hFFFFFFFF;
    else return signed'(b_i) / signed'(a_i);
  endfunction

  function logic [31:0] func_divu(logic [31:0] a, b);
    if (a == 32'd0) return 32'hFFFFFFFF;
    else return unsigned'(b_i) / unsigned'(a_i);
  endfunction
