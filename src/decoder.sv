...
always_ff @( posedge clk_i ) begin 
    if(!rst_i) begin
        ...
        case (inst_i)
            ...
            WFI: inst_to_ctrl_o <= CTRL_WFI;
            ECALL: inst_to_ctrl_o <= CTRL_ECALL;
            EBREAK: inst_to_ctrl_o <= CTRL_EBREAK;
            default: begin
                case (op_code)
                    ...
                    ZICSR: begin
                        case (funct_3)
                            CSRRW: inst_to_ctrl_o <= CTRL_CSRRW;
                            CSRRS: inst_to_ctrl_o <= CTRL_CSRRS;
                            CSRRC: inst_to_ctrl_o <= CTRL_CSRRC;
